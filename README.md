...
- go to your git-hub account and go to your source-code repo in source-code repo go to **( settings )** then click on **( webhooks )** then click on add webhook then in **payload url** type your **( jenkins url )** ( Ex.- http://<<jenkins-public-ip>>:8080/github-webhook/ ) ...then in **( content type )** option select **application json** option...
